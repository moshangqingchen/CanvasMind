...
const styles = {
  ...
  definitionTerm: { color: "var(--muted)" },
  definitionValue: {
    margin: 0,
    color: "var(--text)",
  ...
  actions: {
    display: "grid",
    gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 88px), 1fr))",
    gap: 7,
    padding: 12,
  },
  subtleButton: {
  ...
  totalValue: { color: "var(--text)", fontSize: 18, fontWeight: 750 },
  inlineConfig: {
    margin: "10px 12px 0",
  ...
  composerConfigSelectModel: { flexGrow: 1.35, flexBasis: 160, minWidth: 0 },
  composerConfigSelectReasoning: { flexGrow: 0.85, flexBasis: 100, minWidth: 0 },
  composerConfigEmpty: {
    flex: "1 1 auto",
    minWidth: 0,
    color: "var(--muted)",
